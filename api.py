...
config = {
	'access_token': '4bc0d572a75602c8413ac41cb51dbe4e94955e3e469d53d2b00433ddeb831269d7b84db8a90567c209e2b',
	'plotly_username': 'beliz1729',
	'plotly_api_key': '7NoHDRYPl3cDMKJv1joi',
...
def messages_get_history(user_id, offset=0, count=900):
	...
	while count > 0:
		...
		messages += response['response']['items']
...
def count_dates_from_messages(messages):
	...
	xs = []
	ys = []
	for x, y in sorted(counted.items(), key=lambda t: t[0]):
		xs.append(x)
		ys.append(y)
	return xs, ys
